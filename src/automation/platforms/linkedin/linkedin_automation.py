"""
LinkedIn Automation using DrissionPage - Fixed Profile Path
"""
...
CLIENT_PROFILE_PATH = PROFILES_ROOT / "linkedin"
...
def main():
    ...
    if "login" in page.url or "signup" in page.url or page.url == "https://www.linkedin.com/":
